          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.0281 4.96582C19.9593 4.96582 19.0312 4.03769 19.0312 2.96894C19.0312 1.90019 19.9593 0.972061 21.0281 0.972061C22.0968 0.972061 23.025 1.90019 23.025 2.96894C23.025 4.03769 22.0968 4.96582 21.0281 4.96582Z" fill="#FF6B00"/>
                <path d="M12.0156 24C5.43281 24 0 18.5672 0 11.9844C0 5.40156 5.43281 0 12.0156 0C15.975 0 19.5656 1.95 21.8344 5.1L19.8844 6.3C18.0281 3.7125 15.1219 2.1 12.0156 2.1C6.58594 2.1 2.1 6.55312 2.1 11.9844C2.1 17.4156 6.55312 21.9 12.0156 21.9C17.4469 21.9 21.9 17.4469 21.9 12.0156H24C24 18.5672 18.5672 24 12.0156 24Z" fill="#FF6B00"/>
              </svg>
              <h1 className="text-2xl font-bold text-white">BasePayQR</h1>
            </div>
            <WalletConnect />
          </div>
        </div>
